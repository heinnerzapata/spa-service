                        ...
                        <Row middle="xs">
                          <Col xs={12}>
                            <V7Input
                              ...
                              defaultValue={this.props.userReducer.userInfo.firstName}
                              icon={
                                <V7Icon
                                  icon={faUser}
                                  size={"2x"} />
                        ...
                        <Row middle="xs">
                          <Col xs={12}>
                            <V7Input
                              ...
                              defaultValue={this.props.userReducer.userInfo.lastName}
                              icon={
                                <V7Icon
                                  icon={faUser}
                                  size={"2x"} />
                        ...
                        <Row middle="xs">
                          <Col xs={12}>
                            <V7Input
                              ...
                              defaultValue={this.props.userReducer.userInfo.email}
                              icon={
                                <V7Icon
                                  icon={faAt}
                                  size={"2x"} />
                        ...
                        <Row middle="xs">
                          <Col xs={12}>
                            <V7Input
                              ...
                              defaultValue={this.props.userReducer.userInfo.phoneContact}
                              icon={
                                <V7Icon
                                  icon={faPhone}
                                  size={"2x"} />
